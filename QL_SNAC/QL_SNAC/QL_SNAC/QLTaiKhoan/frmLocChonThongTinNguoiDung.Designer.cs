namespace QL_SNAC.QLTaiKhoan
{
    partial class frmLocChonThongTinNguoiDung
    {
        ...
        private void InitializeComponent()
        {
            ...
            tbNhanSu = new TabPage();
            dgDSNhanSu = new DataGridView();
            ...
            tbNhanSu.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)dgDSNhanSu).BeginInit();
            ...
            TabControl.Controls.Add(tbNhanSu);
            ...
            // tbNhanSu
            // 
            tbNhanSu.Controls.Add(dgDSNhanSu);
            tbNhanSu.Location = new Point(4, 29);
            tbNhanSu.Name = "tbNhanSu";
            tbNhanSu.Size = new Size(669, 218);
            tbNhanSu.TabIndex = 3;
            tbNhanSu.Text = "Nhân sự ";
            tbNhanSu.UseVisualStyleBackColor = true;
            // 
            // dgDSNhanSu
            // 
            dgDSNhanSu.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            dgDSNhanSu.Dock = DockStyle.Fill;
            dgDSNhanSu.Location = new Point(0, 0);
            dgDSNhanSu.Name = "dgDSNhanSu";
            dgDSNhanSu.RowHeadersWidth = 51;
            dgDSNhanSu.Size = new Size(669, 218);
            dgDSNhanSu.TabIndex = 0;
            dgDSNhanSu.CellClick += dgDSNhanSu_CellClick;
            dgDSNhanSu.CellDoubleClick += dgDSNhanSu_CellDoubleClick;
            // 
            // tbPhuHuynh
            // 
            ...
            tbNhanSu.ResumeLayout(false);
            ((System.ComponentModel.ISupportInitialize)dgDSNhanSu).EndInit();
        ...
        private TabPage tbNhanSu;
        private DataGridView dgDSNhanSu;
    }
}